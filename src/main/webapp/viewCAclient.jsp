...
<html>
    <head>
        ...
        <title>Chiffre d'affaire client</title>
        ...
        <script type="text/javascript">
            ...
            <c:forEach items="${code}" var="code">
                ...
                // Set chart options
                var options = {
                    'title': 'Chiffre d\'affaire par client (en euro)', //title
                    is3D: true, //render Google Pie Chart as 3D
                    pieSliceText: 'label', //Affiche le label du client quand on passe la souris
    ...
    <h1>Chiffre d'affaire clients</h1>
    <br>
    <form method='GET'>
